...
class Image {
    ...
    function __construct($aWidth=0,$aHeight=0,$aFormat=DEFAULT_GFORMAT,$aSetAutoMargin=true) {
        ...
        $this->ff_font0 =  imageloadfont(dirname(__FILE__) . "/FF_FONT0.gdf");
        $this->ff_font1 =  imageloadfont(dirname(__FILE__) . "/FF_FONT1.gdf");
        $this->ff_font2 =  imageloadfont(dirname(__FILE__) . "/FF_FONT2.gdf");
        $this->ff_font1_bold =  imageloadfont(dirname(__FILE__) . "/FF_FONT1-Bold.gdf");
        $this->ff_font2_bold =  imageloadfont(dirname(__FILE__) . "/FF_FONT2-Bold.gdf");
    }
